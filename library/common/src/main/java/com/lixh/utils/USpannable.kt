 ...
 */
class USpannable : SpannableStringBuilder {
     ...
     * @return this `USpannable`.
     */
    fun append(text: CharSequence, vararg spans: Any): USpannable {
        append(text)
        for (span in spans) {
    ...
    fun append(text: CharSequence, span: Any): USpannable {
        append(text)
        setSpan(span, length - text.length, length)
        return this
    }
     ...
     * @return this `USpannable`.
     */
    fun append(text: CharSequence, imageSpan: ImageSpan): USpannable {
        var text = text
        text = ".$text"
        append(text)
     ...
     * @return this `USpannable`.
     */
    override fun append(text: CharSequence?): USpannable {
        super.append(text)
        return this
    }
    ...
    fun appendText(text: CharSequence): USpannable {
        append(text)
        return this
    }
     ...
     * @return `USpannable`.
     */
    fun findAndSpan(textToSpan: CharSequence, getSpan: GetSpan): USpannable {
        var lastIndex = 0
        while (lastIndex != -1) {
    ...
    companion object {
        ...
        /**
         * Sets span objects to the text. This is more efficient than creating a new instance of USpannable
