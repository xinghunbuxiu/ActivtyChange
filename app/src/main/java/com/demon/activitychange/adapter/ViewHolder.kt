package com.demon.activitychange.adapter
...
class ViewHolder(private val mContext: Context, val convertView: View, parent: ViewGroup, private var mPosition: Int) {
    private val mViews: SparseArray<View>
    var layoutId: Int = 0
        private set
    var mOpenAnimationEnable = true
    ...
    companion object {
        ...
        operator fun get(context: Context, convertView: View?,
                         parent: ViewGroup, itemView: View, position: Int): ViewHolder {
            if (convertView == null) {

                return ViewHolder(context, itemView, parent, position)
            } else {
                val holder = convertView.tag as ViewHolder
                holder.mPosition = position
                return holder
